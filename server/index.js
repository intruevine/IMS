...
const eventTemplatesRouter = require('./routes/event-templates');
...
app.use('/MA/api/system-settings', systemSettingsRouter);
app.use('/MA/api/event-templates', eventTemplatesRouter);
...
app.get('/', (req, res) => {
  res.json({
    ...
    endpoints: {
      ...
      eventTemplates: '/api/event-templates',
      notices: '/api/notices',
      health: '/health'
    },
    health: '/health'
